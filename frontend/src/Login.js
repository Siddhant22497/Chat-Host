      ...
      <div className="flex items-center justify-center h-screen" style={{
        ...
        <div className='box-content'>
          <form action="" id="form_login" className='border-t-4 border-r-4 border-b-4 border-l-4  border-black h-[71.1vh] w-[25vw] tablet:w-[50vw]'>
            ...
            <br />
            <button className="bg-blue-500 rounded-xl hover:bg-blue-700 hover:scale-105 mt-[2vh] tablet:w-[45vw] ml-[2vw] w-[20vw] h-[7vh] tablet:" onClick={(e) => callSubmit(e)}>Log In</button>
